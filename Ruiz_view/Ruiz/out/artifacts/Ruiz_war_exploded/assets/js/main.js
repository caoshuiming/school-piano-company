...
//Variables
    ...
    $( "#price-slider" ).slider({
        ...
        min: 0,
        max: 1600000,
        values: [ $("input#database_minprice").val(), $("input#database_maxprice").val() ],
...
// Fancybox Active
    ...
    $("select[name='sortby']").bind("change", function () {
        ...
        window.location.href = "goodslist.action?minprice=" + minprice +  "&maxprice=" + maxprice +  "&sort=" + value + "&brand=" + brand + "&category=" + category;
    });

    $("div#pricefilter").bind("click", function () {
        var minprice = $("#min-price").val().substring(1);
        var maxprice = $("#max-price").val().substring(1);
        var value = $(this).val();
        var category = $("input#category").val();
